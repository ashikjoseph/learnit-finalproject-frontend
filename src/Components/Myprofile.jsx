            ...
            <div className='card shadow p-5'>
                ...
                <div>
                    <label htmlFor="profile" className='text-center mb-2 mt-3'>
                        ...
                        <img src="https://png.pngtree.com/png-clipart/20191122/original/pngtree-user-icon-isolated-on-abstract-background-png-image_5192004.jpg" alt="" width={"200px"} height={"200px"} />
                    </label>
                    <div>
                        <div className='mt-3'>
                        ...
                        <div className='mt-3 mb-3'>
                        <input type="text" className='form-control'  placeholder='Syllabus'/>
                        </div>
                        <div className='mt-3 mb-3'>
